...
let handleForm = () => {
    ...
    if (!isLoading.value) {
        ...
        HttpRequest.put('/auth/change-password' , {
        ...
        .then(res => {
            ...
            if(res != undefined)
            {
                password.value = ''
                authStore.clearData()
                toast("پسورد شما با موفقیت آپدیت شد");
...
<template>
    ...
    <form class="form" @submit.prevent="handleForm">
        <InputBox title="رمز عبور جدید" v-model="password" type="password">
